            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Thay cấu hình mặc định bằng cấu trúc link trên tài khoản của bạn. VD (lấy phần in đậm): <b><?php echo VAL_SHOPEE_PREFIX;?></b>/adref:sub1/pubref:sub2/destination:https%3A%2F%2Fshopee.vn</p>
                    </td>
                </tr>
                <tr>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Thay cấu hình mặc định bằng cấu trúc link trên tài khoản của bạn. VD (lấy phần in đậm): <b><?php echo VAL_ACCESSTRADE_PREFIX;?></b>?url=https%3A%2F%2Fshopee.vn&utm_source=sub1&utm_medium=sub2&utm_campaign=sub3&utm_content=sub4</p>
                    </td>
                </tr>
                <tr>
